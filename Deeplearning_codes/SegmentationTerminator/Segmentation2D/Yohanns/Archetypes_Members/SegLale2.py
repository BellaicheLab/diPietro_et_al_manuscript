...
basedir_StardistWater_FijiMask = basedir + '/StarWat_HPNeck6/'
basedir_StardistWater_FijiMask_RTGPipeline = basedir + '/StarWat_HPNeck6_RTGPipeline/'
...
for fname in filesRaw:
    ...
    if os.path.exists((basedir_StardistWater_FijiMask + 'StarWat_HPNeck6' + os.path.basename(os.path.splitext(fname)[0]))) == False :
       ...
       # Binary_Watershed = Integer_to_border(Watershed)
        ...
        save_8bit_tiff_imagej_compatible((basedir_StardistWater_FijiMask + 'StarWat_HPNeck6' + os.path.basename(os.path.splitext(fname)[0]) ) , StardistWater_FijiMask, axes)
...
for fname in filesRaw_2:
    ...
    png.from_array(z, mode="L").save(basedir_StardistWater_FijiMask_RTGPipeline + name.replace("StarWat_HPNeck6_",'seg_') + '.png') 
