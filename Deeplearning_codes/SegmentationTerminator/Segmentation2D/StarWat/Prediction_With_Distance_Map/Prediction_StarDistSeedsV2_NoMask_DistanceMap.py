# StarDistSeedsV2_NoMask_DistanceMap.py
...
TriggerName = '/home/sancere/NextonDisk_1/TimeTrigger/TTGhost'
TimeCount = 0
...
basedir = '/run/user/1000/gvfs/smb-share:server=isiserver.curie.net,share=u934/service_imagerie/v_kapoor/Lucas2Varun/wt_mov8'
...
for fname in filesRaw:
    ...
    if os.path.exists((basedir_StardistWater_FijiMask + 'StarWatDistance_' + os.path.basename(os.path.splitext(fname)[0]))) == False :
            ...
            #Seeds from Stardist + Whatershed, segmentation on Distance map
            ...
            save_8bit_tiff_imagej_compatible((basedir_StardistWater_FijiMask + 'StarWatDistance_' + os.path.basename(os.path.splitext(fname)[0]) ) , StardistWater_FijiMask, axes)
            # save_tiff_imagej_compati/run/user/1000/gvfs/smb-share:server=isiserver.curie.net,share=u934/service_imagerie/v_kapoor/Lucas2Varun/wt_mov8ble((basedir_StardistWater_FijiMask + 'DistMap_' + os.path.basename(os.path.splitext(fname)[0]) ) , maxdist, axes)
...
for fname in filesRaw_2:
    ...
    png.from_array(z, mode="L").save(basedir_StardistWater_FijiMask_RTGPipeline + name.replace("StarWatDistance_",'seg_') + '.png') 
...
TriggerName = '/home/sancere/NextonDisk_1/TimeTrigger/TTNoMaskDist'
