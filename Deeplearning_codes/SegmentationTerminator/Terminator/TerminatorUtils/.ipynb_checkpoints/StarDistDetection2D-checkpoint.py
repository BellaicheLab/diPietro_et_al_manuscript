...
class StarDistDetection2D(object):
     ...
     def __init__(self, ImageDirectory, LabelDirectory, model_dir, model_name, copy_model_name = None, patch_size = (256, 256), length =1, use_gpu = True, unet_n_depth = 5, n_rays = 256, epochs = 100, learning_rate = 0.0001):
     ...
     def loadData(self):
         ...
         self.X = list(map(ReadFloat,self.X))
         self.Y  = list(map(ReadInt,self.Y))
