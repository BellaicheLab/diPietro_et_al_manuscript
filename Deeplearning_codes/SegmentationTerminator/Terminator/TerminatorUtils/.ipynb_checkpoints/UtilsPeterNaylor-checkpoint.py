#FROM PETER NAYLOR: https://github.com/lucas-sancere/DRFNS/blob/master/src_RealData/utils.py
...
from TerminatorUtils.postprocessingPeterNaylor import PostProcess, generate_wsl
