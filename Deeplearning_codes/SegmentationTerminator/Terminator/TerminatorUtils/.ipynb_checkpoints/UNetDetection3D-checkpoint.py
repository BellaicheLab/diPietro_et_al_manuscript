...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 29 23:42:59 2019
...
from TerminatorUtils.UNET import UNet3D
...
class UNetDetection3D(object):
     ...
     def __init__(self, NpzDirectory, TrainModelName, model_dir, model_name, model_weights, train_patch_size = (16, 256, 256),  epochs = 100, learning_rate = 0.0001):
     ...
     def TrainModel(self):
         ...
         Binarymodel = UNet3D(1,1, model_weights=self.model_weights)
